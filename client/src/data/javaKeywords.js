export const javaKeywords = [
    ...
    'List', 'ArrayList', 'LinkedList', 'Queue', 'Deque', 'ArrayDeque',
    ...
    'length', 'charAt', 'substring', 'indexOf', 'lastIndexOf', 'equals', 'compareTo',
    'toLowerCase', 'toUpperCase', 'trim', 'split', 'replace', 'replaceAll',
    'startsWith', 'endsWith', 'append', 'delete', 'deleteCharAt', 'insert', 'setCharAt',
